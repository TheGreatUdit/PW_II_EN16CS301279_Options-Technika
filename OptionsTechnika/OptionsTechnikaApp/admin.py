...
from OptionsTechnikaApp.models import contact_model, enquiry_model,register_model, course_assign,course_pro,alumini_model
...
class AluminiAdmin(admin.ModelAdmin):
    list_display=['name','filepath','email','company','age','salary']
admin.site.register(alumini_model,AluminiAdmin)
