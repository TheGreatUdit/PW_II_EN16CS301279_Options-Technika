...
from OptionsTechnikaApp.models import contact_model,enquiry_model,course_assign,course_pro,register_model
...
def register2(request):
    if request.method=='POST':
        return render(request,'OptionsTechnikaApp/register2.html')
    else:
        return render(request,'OptionsTechnikaApp/register2.html')
...
def counsellor(request,username):
    ...
    enquiry_count=enquiry_model.objects.filter(status='Enquiry').count()
